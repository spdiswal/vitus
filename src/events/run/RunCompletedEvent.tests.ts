...
describe("given a project of 4 files with a mix of tests where 2 files have status 'passed', 1 file has status 'failed', and 1 file has status 'running'", () => {
	...
	describe("when the run has completed", () => {
		...
		it("refreshes the project duration based on the remaining files", () => {
			expect(actualProject.duration).toBe(initialProjectDuration - 20)
		})
