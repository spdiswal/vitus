...
describe("when a non-existing top-level test has failed", () => {
	let actualProject: Project
...
describe("when a top-level test in a non-existing file has failed", () => {
	let actualProject: Project
...
// TODO: when a nested test has failed
