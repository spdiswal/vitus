import { dummyFileDto } from "+api/models/FileDto.fixtures"
...
export function dummyStateDto(): StateDto {
	return {
		...
		files: [
			dummyFileDto("15b021ef72", { duration: 10, status: "started" }),
			dummyFileDto("a3fdd8b6c3", { duration: 20, status: "passed" }),
			dummyFileDto("-1730f876b4", { duration: 40, status: "passed" }),
			dummyFileDto("-e45b128829", { duration: 80, status: "started" }),
		],
		subtasks: [
